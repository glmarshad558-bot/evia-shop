...
if __name__ == '__main__':
    # Ensure the upload folder exists so images don't cause errors
    ...
    # Render requires the host to be '0.0.0.0' and a specific port
    # We use os.environ.get to let Render choose the port automatically
